...
namespace App.Scripts.Libs.FancyScrollView.Sources.Runtime.Core
{
    /// <summary>
    ...
    public abstract class FancyScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        ...
        protected virtual FancyCell<TItemData, TContext> CreateCell()
        {
        ...
        protected virtual void OnCellCreated(FancyCell<TItemData, TContext> cell)
        {
        }
